...
chirps = ah.Forcing(session, 'earthengine-public',
...
era5 = ah.Forcing(session, 'earthengine-public',
...
model.writeSoilParam(basinSoil,elv,precip,b_val=0.2,Ws_val=0.01,Ds_val=0.9,s2=0.2,s3=0.7,c=2)
# write model snow parameter file
model.writeSnowParam(elv,interval=500)
# write model vegetation parameter file
model.writeVegParam(basinLc.isel(time=-1))
